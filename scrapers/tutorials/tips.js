...
const getRawHtml = async () => {
  let chapters = [
    ...
    {
      category: "Tips for Successful Puddings, Custards, and Frozen Desserts", //
      name: "chapter 18",
      start: 977,
      end: 983,
